...
%% Get structures to plot and t-values - in the future make it automatic
  ...
  Structures_to_plot={'Left Thalamus' 'Left Putamen' 'Right Putamen' 'Left Hippocampus' 'Left Amygdala' 'Right Amygdala' 'Left Accumbens' 'Right Accumbens'};
  tvalues=[-3.34319143957526 -2.20137186916968 -4.9051771040626 -2.80557262418731 -6.13824272329294 -6.108430205511150 -5.05836292810321 -4.94402147406857]; 
...
Structures_to_plot={'Left Thalamus' 'Left Putamen' 'Right Putamen' 'Left Hippocampus' 'Left Amygdala' 'Right Amygdala' 'Left Accumbens' 'Right Accumbens'};
tvalues=[-3.29766855411925 -2.21182630675955 -4.89717542627447 -2.95714417130554 -6.674061366826 -6.15024913108907 -5.14561658485501 -5.18757999267968]; 
